...
# Current LTS as of 2025-04-09; update as needed
node_major=22
...
npm install -g \
  ...
  vscode-langservers-extracted eslint_d neovim @bitwarden/cli @google/gemini-cli
...
vn="v0.25.5"
ts="tree-sitter-linux-x64"

curl -L \
  "https://github.com/tree-sitter/tree-sitter/releases/download/$vn/$ts.gz" \
  | zcat > /tmp/tree-sitter

chmod +x "/tmp/tree-sitter"

mv "/tmp/tree-sitter" ~/bin/
